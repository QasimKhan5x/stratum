...
role (qwen3.7-max, thinking on) — deep reasoning matters most here, since
this is the final multi-objective synthesis step. Thinking tokens are
intended to stream to the debate panel live.
"""
